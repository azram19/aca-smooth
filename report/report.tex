...
\begin{tikzpicture}
  \begin{axis}[
    title=Execution time for small.vtu,
    area style,
...
\begin{tikzpicture}
  \begin{axis}[
    title=Execution time for medium.vtu,
    area style,
    ylabel=execution time(s),
    xlabel=measurement,
    enlarge x limits=false]
...
\begin{tikzpicture}
  \begin{axis}[
    title=Comparison of execution time for small.vtu,
    area style,
    ylabel=execution time(s),
    xlabel=measurement,
    enlarge x limits=false]
...
\begin{tikzpicture}
  \begin{axis}[
    title=Comparison of execution time for medium.vtu,
    area style,
    ylabel=execution time(s),
    xlabel=measurement,
    enlarge x limits=false]

...
The first significant observation was that SVDs are computed multiple times while the parameters which they depend on does not change between iterations. We used that to use technique called memoization to make sure that we are not computing the same values multiple times.  
